    ...
    <div className="bg-white w-full max-w-full overflow-hidden">
      ...
      <div className="px-4 py-12 text-center">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-2xl md:text-4xl font-bold mb-2">Why Choose O2 Fitness Healthcare</h1>
          ...
          <p className="text-sm md:text-base text-gray-700 leading-loose mb-1">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="p-[2px] rounded-lg bg-gradient-to-r from-orange-400 to-blue-400">
            ...
            <div className="bg-white rounded-lg shadow-xl flex flex-col lg:flex-row items-stretch justify-between relative">
              ...
              {/* Card 1 */}
              <div className="relative flex-1 px-4 md:px-6 py-6 text-left">
                <h4 className="text-base md:text-lg font-bold mb-2">Advanced Technology</h4>
              ...
              {/* Card 2 */}
              <div className="flex-1 px-4 md:px-6 py-6 text-left">
                <h4 className="text-base md:text-lg font-bold mb-2">Free Delivery & Service</h4>
                <p className="text-xs md:text-sm text-gray-700">
              ...
              {/* Card 3 */}
              <div className="flex-1 px-4 md:px-6 py-6 text-left">
                <h4 className="text-base md:text-lg font-bold mb-2">1-Year Guarantee + 2-Year Warranty</h4>
                <p className="text-xs md:text-sm text-gray-700">
              ...
              {/* Card 4 */}
              <div className="relative flex-1 px-4 md:px-6 py-6 text-left">
                <h4 className="text-base md:text-lg font-bold mb-2">Free Door Delivery Across India</h4>
                <p className="text-xs md:text-sm text-gray-700">
