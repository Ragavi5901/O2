...
const About02Fit = () => {
  return (
    <section className="relative w-full  bg-cover bg-center text-white">
      <img src={Banner} alt="Banner" className="w-full h-[80vh] md:h-auto object-cover" />
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center px-4 text-center">
        <div className="bg-white/30 backdrop-blur-md rounded-2xl text-sm text-white shadow-xl w-[95%] max-w-3xl p-6 sm:p-10 overflow-y-auto max-h-[90vh]">
  <h1 className="text-lg sm:text-3xl font-bold text-orange-500 mb-4 text-center">
